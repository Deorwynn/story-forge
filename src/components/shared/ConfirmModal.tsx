...
export default function ConfirmModal({
  ...
  return (
    <div
      ...
      onClick={(e) => {
        e.stopPropagation();
        onCancel?.(); // Close on backdrop click if onCancel exists
      }} // Prevent closing/triggering stuff behind
    >
      <div
      ...
      >
        ...
        <div className="flex gap-3">
          ...
          <Button
            ...
            className={`flex-1 ${!onCancel ? 'w-full' : ''} ${variant === 'danger' ? '!bg-red-500 hover:!bg-red-600 !border-red-600 shadow-red-100' : ''}`}
            onClick={(e) => {
              e.stopPropagation();
              onConfirm();
            }}
