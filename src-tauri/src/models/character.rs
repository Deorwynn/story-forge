...
pub struct CharacterMetadata {
    ...
    pub height: Option<TemporalField<String>>,
    pub physique: Option<TemporalField<String>>,
    pub apparent_age: Option<TemporalField<String>>,
    pub hair: Option<TemporalField<String>>,
    pub eye_color: Option<TemporalField<String>>,
    pub scars: Option<TemporalField<String>>,
    pub tattoos: Option<TemporalField<String>>,
    pub distinctive_features: Option<TemporalField<String>>,
    pub clothing_style: Option<TemporalField<String>>,
    pub posture_gait: Option<TemporalField<String>>,
    pub color_palette: Option<TemporalField<String>>,
}